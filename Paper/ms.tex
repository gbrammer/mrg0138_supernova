...
\begin{deluxetable*}{ccccccr}
    \tablecaption{Additional archival data}
    
    \tablehead{\colhead{Telescope} & \colhead{Instrument} & \colhead{$\lambda_\mathrm{obs}$} & \colhead{Observation date} & \colhead{MJD} & \colhead{Exp. time (s)}}
\startdata
...
To evaluate the age of each transient image (and therefore constrain the lensing time delay between images), it is valuable to have a firm determination of the transient's class.  The range of possible transients is broad, encompassing normal SNe, superluminous SNe \citep{galyam_luminous_2019}, fast transients \citep{berger_fast_2013, drout_rapidly_2014}, and even gravitational microlensing events \citep{rodney_two_2018,kelly_extreme_2018}.  Identifying the transient type makes it possible to use the well-developed library of spectrophotometric SN models \citep[e.g.][]{kessler_models_2019} for the time delay measurement. 
 ...
 \SR{Add to bib file: Gal-Yam SLSN review 2019ARAA..57..305G;
 \href{https://ui.adsabs.harvard.edu/abs/2013ApJ...779...18B/abstract}{berger 2013};
\href{https://ui.adsabs.harvard.edu/abs/2014ApJ...794...23D/abstract}{Drout Fast transients};
Rodney 2018;  Kelly 2018
 }}
...
We first seek to classify this SN {\it circumstantially}, using measured properties of the host galaxy's stellar population to infer the SN's type. Although Type Ia SNe \citep{mannucci_rates_2005,foley_classifying_2013}.

\SR{TODO:  explain and cite host-based classifications, e.g. Mannucci et al. 2005,   Galsnid:  Foley and Mandel}

Discussion from Newman et al. \cite{newman_resolving_2018,newman_resolving_2018-1}.
